...
export default function PdfPage() {
  ...
  return (
    <div className="max-w-[1400px] mx-auto w-full min-w-0 p-3 sm:p-6 lg:p-8 space-y-6 sm:space-y-8 animate-in fade-in duration-500 pb-24">
      {/* Header Controls */}
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div className="min-w-0">
          <h1 className="text-2xl sm:text-3xl font-bold tracking-tight text-foreground">Invoices</h1>
          <p className="text-sm sm:text-base text-muted-foreground mt-1">Generate professional PDF invoices for your clients.</p>
        </div>
