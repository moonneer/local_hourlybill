              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between gap-3">
                  ...
                  <button
                    ...
                    className="text-muted-foreground hover:text-foreground p-2 -mr-1 rounded-md transition-colors focus:outline-none focus:ring-2 focus:ring-primary/20 touch-manipulation min-h-10 min-w-10 inline-flex items-center justify-center"
