...
export default function LoginPage() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-full py-12 px-4 bg-slate-50/50 selection:bg-primary/20 selection:text-primary">
      <div className="w-full max-w-[420px] space-y-8 animate-in fade-in zoom-in-95 duration-500">
        ...
        <Card className="border-border/60 shadow-xl bg-white/80 backdrop-blur-sm">
          ...
          <CardContent>
            <form key={mode} onSubmit={handleSubmit(onSubmit)} className="space-y-5">
              {mode === "signup" && (
                <>
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between gap-3">
                  ...
                  <button
                    ...
                    className="text-muted-foreground hover:text-foreground p-1.5 rounded-md transition-colors focus:outline-none focus:ring-2 focus:ring-primary/20"
