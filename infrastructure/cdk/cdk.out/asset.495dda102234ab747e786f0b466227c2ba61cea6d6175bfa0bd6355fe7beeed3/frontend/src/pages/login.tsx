          ...
          <CardContent className="px-4 sm:px-6 pb-6">
            <form key={mode} onSubmit={handleSubmit(onSubmit)} className="space-y-4 sm:space-y-5">
              ...
              <div className="space-y-2">
                <Label
                  htmlFor="password"
                  className="flex w-full cursor-default items-center justify-between gap-2 text-xs font-semibold uppercase tracking-wider text-muted-foreground"
                >
                  <span>Password</span>
                  <button
                    type="button"
                    ...
                    className="inline-flex h-8 w-8 shrink-0 items-center justify-center rounded-md text-muted-foreground transition-colors hover:text-foreground focus:outline-none focus:ring-2 focus:ring-primary/20 touch-manipulation"
